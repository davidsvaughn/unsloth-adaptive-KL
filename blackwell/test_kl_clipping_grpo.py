...
print("2. Per-token hard clipping - F.relu(KL - per_token_threshold * length)")
print("3. Per-token soft clipping - F.softplus(KL - per_token_threshold * length)")
print("4. Total KL threshold - F.softplus(KL - total_threshold)")
